...
export function defaultCapabilities() {
  return [
    ...
    { capabilityId: 'code.execute', providerId: 'codex', supportedActions: ['execute', 'test', 'build', 'debug'], inputTypes: ['text', 'workspace'], riskLevel: 'medium', availability: 'available', estimatedLatency: 30000, estimatedCost: 5, historicalSuccessRate: 0.95, requiresConfirmation: false, verificationMethod: 'independent_result_verifier', fallbackProviders: [] },
    { capabilityId: 'code.modify', providerId: 'codex', supportedActions: ['write', 'modify', 'fix'], inputTypes: ['text', 'workspace'], riskLevel: 'medium', availability: 'available', estimatedLatency: 60000, estimatedCost: 8, historicalSuccessRate: 0.94, requiresConfirmation: false, verificationMethod: 'diff_and_tests', fallbackProviders: [] },
    ...
    { capabilityId: 'process.stop', providerId: 'local-process-provider', supportedActions: ['stop'], inputTypes: ['exact_process_name', 'pid'], riskLevel: 'medium', availability: process.platform === 'win32' ? 'available' : 'unavailable', estimatedLatency: 1000, estimatedCost: 0, historicalSuccessRate: 0.98, requiresConfirmation: false, verificationMethod: 'post_stop_process_snapshot', fallbackProviders: ['fallback-process-provider'] },
    { capabilityId: 'process.stop', providerId: 'fallback-process-provider', supportedActions: ['stop'], inputTypes: ['pid'], riskLevel: 'medium', availability: 'unavailable', estimatedLatency: 2000, estimatedCost: 1, historicalSuccessRate: 0.9, requiresConfirmation: false, verificationMethod: 'post_stop_process_snapshot', fallbackProviders: [] }
  ];
}
