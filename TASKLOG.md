...
| DeepSeek V4 Flash 非思考兼容 Worker 上传、Preview、真实验证和生产切流 | 全量生产切换完成，等待验收 | version 13 已上传并通过无付费 Preview、真实 Preview 链路、1% 生产灰度和 100% 全量生产观察；当前 version 13 承载 100% 正常生产流量。等待产品负责人验收；未经批准不得发起新的主动真实调用或进入模型分层、上下文压缩、v0.4.7 或其他新阶段。 |
