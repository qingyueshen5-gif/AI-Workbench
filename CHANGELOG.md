...
- 当前 `gh auth status` 未登录，`git fetch origin` 因 GitHub 凭证缺失失败；本轮阻塞记录 commit `0584ef660106d516cb25deabe8c6347c0bc47337` 已成功 push，但恢复 `gh` 前仍不能读取 Actions artifact 或触发/观察 workflow。
