...
当前尚无真实用户。模型调用成本由产品承担，且平台月度总上限尚未建立；现金跑道约 8 个月，月支出约 8200。当前目标是盈亏平衡和知名度，不是收费或利润最大化。
...
- 阶段性总审核（砍薄版）完成后需等待产品负责人验收；未经批准不得进入生存体检或其他任务。
...
不得自动进入生存体检、实际电脑清理、首屏示例、反馈入口、安全告知、真实用户测试、模型分层、手机端、情报流水线或任何新功能开发。
