...
| 真实验收证据 | `verification/` |
| 调研和候选方案 | `research/` |
| 运行环境问题状态、事故时间线和证据索引 | `ENVIRONMENT_OPS_ISSUES.md`；当前只读基线见`verification/environment-ops-readonly-baseline/`，单次生成最小就绪核验见`verification/ai-link-readiness/`，上游路由定性和版本3方案审查见`verification/ai-link-route-and-review/` |
